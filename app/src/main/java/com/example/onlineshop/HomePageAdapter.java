...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class BannerSliderViewHolder extends RecyclerView.ViewHolder {
        ...
        private List<SliderModel> arringedList;
        ...
        private void setBannerSliderViewPager(final List<SliderModel> sliderModelList) {
            ...
            arringedList = new ArrayList<>();
            for (int x=0; x<sliderModelList.size(); x++){
                arringedList.add(x, sliderModelList.get(x));
            }

            arringedList.add(0, sliderModelList.get(sliderModelList.size()-2));
            arringedList.add(1, sliderModelList.get(sliderModelList.size()-1));

            arringedList.add(sliderModelList.get(0));
            arringedList.add(sliderModelList.get(1));

            SliderAdapter sliderAdapter = new SliderAdapter(arringedList);
            ...
            ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() {
                ...
                public void onPageScrollStateChanged(int i) {
                    if (i == ViewPager.SCROLL_STATE_IDLE) {
                        pageLooper(arringedList);
                    }
                }
            };
            bannerSliderViewPager.addOnPageChangeListener(onPageChangeListener);

            startBannerSlideShow(arringedList);
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder{
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            ...
            horizontalLayoutViewAllBtn = itemView.findViewById(R.id.horizontal_scroll_layout_viewAllBtn);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setGridProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, String title){
            ...
            for (int x=0; x<4; x++){
                ImageView productImage = gridProductLayout.getChildAt(x).findViewById(R.id.horizontalScroll_productImage);
                TextView productTitle = gridProductLayout.getChildAt(x).findViewById(R.id.horizontalScroll_productTitle);
                TextView productDescription = gridProductLayout.getChildAt(x).findViewById(R.id.horizontalScroll_productDescription);
                TextView productPrice = gridProductLayout.getChildAt(x).findViewById(R.id.horizontalScroll_productPrice);
