...
public class CartAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (cartItemModelList.get(position).getType()) {
            ...
            case CartItemModel.TOTAL_AMOUNT:
                ...
                ((CartTotalAmountViewHolder) viewHolder).setTotalAmount(totalItems, totalItemPrice, deleveryPrice, totalAmount, savedAmount);
                break;
            default:
                return;
        }
    ...
    class CartItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setItemDetails(int resource, String title,
                                    int freeCoupensNo,
                                    String productPriceText,
                                    String cuttedPriceText,
                                    int offersAppliedNo) {
